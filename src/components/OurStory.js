  ...
  return (
    <div className="our-story">
      ...
      <section className="container has-text-centered">
        ...
        <p className="m-6 is-size-6-touch">
          Verve Properties are an ethical property firm that regenerates old buildings with the intent to bring communities together and provide an offering for everyone. The company have an ethical and sustainable ethos and focus on working with and securing local, independent, and socially conscious brands and businesses, to ensure that the regeneration reflects the changes Covid has accelerated in social and shopping patterns.
        </p>
        <p className="m-6 is-size-6-touch">
          Building work has been split into a number of phases to ensure the store can open as soon as possible, with phase one opening on 7th August, with more elements opening all the way through the year and into 2022. First to open will be Bobby’s Beauty Hall, Bobby’s Ice Cream Parlour, an art gallery, and Drool - the world’s first food and beverage outlet for dogs, based in the tunnel leading to the Lower Gardens.
        </p>
        <p className="m-6 is-size-6-touch">
          The beauty hall will house local, sustainable, and conscious brands sitting alongside the big global brands we are all familiar with. As an independent beauty operation, Bobby’s Beauty Hall will offer products and brands not previously available at Debenhams, who previously occupied the site. There will also be a Sushi and plant-based Poke Bowl Bar, treatment rooms, female and male grooming. The watch repairing station ‘In Time’ will be retained which is the only watch repair shop nearby.
        </p>
        <p className="m-6 is-size-6-touch">
          On the first floor the large windows overlooking the Square will be opened up, new balconies installed, and the floor will house a food and market hall which is due to open later this summer. This will include street food outlets including plant-based food, a deli, a bar and speciality retail market pods. Spa facilities are in the planning stages and will hopefully open in 2022.
        </p>
        <p className="m-6 is-size-6-touch">
        The second floor will house an art gallery with more details to be revealed in the coming weeks. 
        </p>
        <p className="m-6 is-size-6-touch"> 
        Accessed from Terrace Road, old buildings at the rear will be reorganised to create a garden area and a micro-brewery/craft ale smokery bar. Following that, plans are in place to open a fourth floor bar/restaurant and roof terrace bar. – all with a key focus on the local community.
        </p>
        <p className="m-6 is-size-6-touch"> 
        ...
        <p className="m-6 is-size-6-touch"> 
        And with The Twentieth Century Society reporting in the Observer last month that “landmark UK department stores up and down the country are at risk as Covid changes city centres and that locally beloved buildings, from 1930s classics to brutalist edifices, are facing developers’ wrecking balls” [source] – it is little wonder that people in the area were concerned. Verve hopes that this commitment to restore Bobby’s to its former glory will be welcomed by residents and visitors alike. 
